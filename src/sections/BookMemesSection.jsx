    ...
    <section id="book-memes" className="px-6 py-24 md:py-28">
      <div className="mx-auto max-w-6xl">
        ...
        <SectionReveal delay={0.05}>
          <div className="mx-auto mt-12 max-w-5xl rounded-[2rem] border border-candle-gold/35 bg-gradient-to-br from-[#261833]/85 via-[#21162d]/90 to-[#1a1224]/85 p-4 shadow-[0_24px_56px_rgba(8,6,12,0.55)] md:p-6">
            <div className="relative overflow-hidden rounded-[1.6rem] border border-candle-gold/25 bg-[#140f1b]/92 px-2 py-5 md:px-3">
              ...
              >
                {bookMemesGallery.map((image, index) => (
                  <article
                    key={image}
                    className="w-[62vw] max-w-[440px] shrink-0 snap-center overflow-hidden rounded-2xl border border-candle-gold/30 bg-[#1a1224] sm:w-[56vw] md:w-[34vw] lg:w-[29vw]"
                  >
